...
- **Розклад зустрічей**: [Meetup](https://meetup.events/index.html#meetup/2)
...
Для деталей щодо конкретної зустрічі, дивіться [сторінку на Meetup](https://meetup.events/index.html#meetup/2).
